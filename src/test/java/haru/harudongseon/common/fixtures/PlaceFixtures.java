...
public class PlaceFixtures {
    ...
    public static Place 기본_장소_도메인(final Long id) {
        return new Place(id, 기본_장소1_외부_공급자_ID, 기본_장소1_이름, 기본_장소1_카테고리, 기본_장소1_사진_참조, 기본_장소1_좌표, 기본_장소1_영업_시간, 기본_장소1_주소_이름, 기본_장소1_전화번호, 기본_장소1_웹사이트, 기본_장소1_구글_맵_URL, 기본_장소1_세부_정보);
    }
