...
public class PlaceFixtures {
    ...
    public static final List<String> 기본_장소_사진_참조 = List.of("ATJ83zhSSAtk1", "ATJ83zhSSAtk2", "ATJ83zhSSAtk3");
    ...
    public static final DeliveryAvailable 기본_장소_배달_가능_여부 = DeliveryAvailable.NONE;
    public static final PlaceDetails 기본_장소_세부_정보 = new PlaceDetails(기본_장소_예약_가능_여부, 기본_장소_포장_가능_여부, 기본_장소_배달_가능_여부);
