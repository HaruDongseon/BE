...
public class LikePlaceFixtures {
    ...
    public static final DeliveryAvailable 기본_보관_장소_배달_가능_여부 = DeliveryAvailable.NONE;
    public static final PlaceDetails 기본_보관_장소_세부_정보 = new PlaceDetails(기본_보관_장소_예약_가능_여부, 기본_보관_장소_포장_가능_여부, 기본_보관_장소_배달_가능_여부);

    public static LikePlace 기본_보관_장소_Entity(final Member member) {
        return new LikePlace(member, 기본_외부_공급자_ID, 기본_보관_장소_이름, 기본_보관_장소_사진_참조, 기본_보관_장소_좌표, 기본_보관_장소_영업_시간, 기본_보관_장소_주소_이름, 기본_보관_장소_전화번호, 기본_보관_장소_웹사이트, 기본_보관_장소_URL, 기본_보관_장소_세부_정보);
    }
}
